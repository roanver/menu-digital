<x-guest-layout>
    ...
    <p style="margin:0 0 28px;font-size:14px;color:#5C5245;line-height:1.5;">Ingresa para administrar la carta de tu restaurante.</p>
    ...
    <form method="POST" action="{{ route('login') }}" style="display:flex;flex-direction:column;gap:16px;">
        ...
        <label style="display:inline-flex;align-items:center;gap:9px;cursor:pointer;font-size:13px;font-weight:600;color:#5C5245;">
            <input id="remember_me" type="checkbox" name="remember"
                   style="width:17px;height:17px;border-radius:5px;border:1.5px solid #201914;accent-color:#E85D2F;cursor:pointer;">
