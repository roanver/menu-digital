<x-guest-layout
    ...
    <h1 style="margin:0 0 6px;font-family:Fraunces,Georgia,serif;font-size:28px;font-weight:700;letter-spacing:-.02em;line-height:1.08">Crea una nueva contraseña</h1>
    <p style="margin:0 0 24px;font-size:14px;color:#4A4A42;line-height:1.5">Elige una contraseña segura para tu cuenta.</p>
